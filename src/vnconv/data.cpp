...
{{'A','a','∏','∏','µ','µ','∂','∂','∑','∑','π','π', //a
  ...
  'J','j','K','k','L','l','M','m','N','n',
  'O','o','„','„','ﬂ','ﬂ','·','·','‚','‚','‰','‰',		// 6: o
  '§','´','Ë','Ë','Â','Â','Ê','Ê','Á','Á','È','È',		// 7: o^
  '•','¨','Ì','Ì','Í','Í','Î','Î','Ï','Ï','Ó','Ó',		// 8: o+
  'P','p','Q','q','R','r','S','s','T','t',
  'U','u','Û','Û','Ô','Ô','Ò','Ò','Ú','Ú','Ù','Ù',		// 9: u
  '¶','≠','¯','¯','ı','ı','ˆ','ˆ','˜','˜','˘','˘',		//10: u+ 
  'V','v','W','w','X','x',
  'Y','y','˝','˝','˙','˙','˚','˚','¸','¸','˛','˛',		//11: y
  'Z','z',
...
{ 'A','a','¡','·','Ä','‡','Å','‰','Ç','„','Â','Â',
  ...
  'Ò','«',
  'E','e','…','È','◊','Ë','ﬁ','»','˛','Î','À','À',
  ' ','Í','ê','â','ì','ä','î','ã','ï','Õ','å','å',
  'F','f','G','g','H','h',
  'I','i','¥','Ì','µ','Ï','∑','Ã','∏','Ô','Œ','Œ',
  'J','j','K','k','L','l','M','m','N','n',
  'O','o','π','Û','º','Ú','Ω','’','æ','ı','Ü','Ü',
  '‘','Ù','ñ','”','ó','“','ò','∞','ô','á','∂','∂',
  '˜','÷','ù','ß','û','©','ü','™','¶','´','Æ','Æ',
  'P','p','Q','q','R','r','S','s','T','t',
  'U','u','⁄','˙','®','˘','—','˚','¨','€','¯','¯',
...
{ 'A','a','¿','¿','™','™','∂','∂','∫','∫','¡','¡',
  ...
  'O','o','‚','‚','ﬂ','ﬂ','‡','‡','·','·','„','„',
  'ö','§','Á','Á','‰','‰','Â','Â','Ê','Ê','Ë','Ë',
  'õ','•','Ï','Ï','È','È','Í','Í','Î','Î','Ì','Ì',
  'P','p','Q','q','R','r','S','s','T','t',
  'U','u','Ú','Ú','Ó','Ó','Ô','Ô','Ò','Ò','Û','Û',
  'ú','ß','˜','˜','Ù','Ù','ı','ı','ˆ','ˆ','¯','¯',
  'V','v','W','w','X','x',
  'Y','y','¸','¸','˘','˘','˙','˙','˚','˚','ˇ','ˇ',
  'Z','z',
